"""Figures: fair-value distribution and WACC × terminal-growth sensitivity."""
...
def plot_fair_value_distribution(
    ...
    """Histogram of MC fair values with the market EV and median marked."""
...
def plot_sensitivity_heatmap(
    ...
    """WACC × g_term heatmap of EV, annotated with % premium to market EV."""
    ...
    ax.set_title(
        f"{ticker}: DCF value vs market EV across WACC × terminal growth\n"
...
def plot_implied_growth_context(
    ...
    """Bar chart of historical revenue growth with the market-implied rate."""
